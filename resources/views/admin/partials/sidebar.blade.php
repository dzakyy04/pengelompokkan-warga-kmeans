...
<aside id="sidebar"
    ...
    <div class="flex items-center px-6 h-16 border-b border-gray-200 dark:border-slate-700 flex-shrink-0 transition-colors duration-200">
        <div class="flex items-center">
            <img src="{{ asset('images/logo-banyasin.png') }}" alt="Logo Desa Sungai Rebo" class="w-10 h-10 rounded-lg object-contain flex-shrink-0">
            <h1 class="text-sm font-bold text-emerald-700 dark:text-emerald-400 sidebar-text ml-3">DESA<br>SUNGAI REBO</h1>
        </div>
    </div>
    ...
    <nav class="flex-1 overflow-y-auto px-4 scrollbar-hide">
        ...
        <a href="{{ route('admin.master-status-produktivitas.index') }}"
            class="flex items-center px-3 py-2.5 mb-1 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors duration-200 group {{ request()->routeIs('admin.master-status-produktivitas.*') ? 'bg-emerald-50 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400 font-semibold' : 'text-gray-500 dark:text-gray-400' }}">
            <svg class="w-5 h-5 mr-3 flex-shrink-0 {{ request()->routeIs('admin.master-status-produktivitas.*') ? 'text-emerald-600 dark:text-emerald-400' : 'text-gray-400 dark:text-gray-500 group-hover:text-gray-600 dark:group-hover:text-gray-300' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
            </svg>
            <span class="text-sm sidebar-text">Status Produktivitas</span>
        </a>
        @endif
        ...
        <a href="{{ route('admin.clustering.pending-classifications') }}"
            ...
            <span class="text-sm sidebar-text">Verifikasi Data</span>
