...
<div class="max-w-4xl">
    ...
    <form method="POST" action="{{ route('admin.warga.store') }}">
        ...
        <div class="flex gap-3 mt-6">
            <button type="submit" class="px-6 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-semibold rounded-xl transition shadow-sm">Simpan</button>
