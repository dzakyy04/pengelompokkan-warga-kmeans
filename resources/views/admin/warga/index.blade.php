...
<div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-200 dark:border-slate-700 p-4 mb-4 transition-colors duration-200">
    <form method="GET" class="flex flex-col md:flex-row gap-3">
        ...
        <select name="pekerjaan_id" class="px-4 py-2.5 border border-gray-300 dark:border-slate-600 rounded-xl text-sm bg-white dark:bg-slate-900 text-gray-900 dark:text-white focus:ring-2 focus:ring-emerald-500 outline-none transition-colors duration-200">
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-slate-700">
                ...
                <tr class="hover:bg-emerald-50/50 dark:hover:bg-slate-700/50 transition-colors">
                    ...
                    <td class="px-4 py-3 text-center">
                        <div class="flex items-center justify-center gap-1">
                            <a href="{{ route('admin.warga.edit', $w) }}" class="p-1.5 text-gray-400 dark:text-gray-500 hover:text-emerald-600 dark:hover:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-900/30 rounded-lg transition" title="Edit">
                ...
                @empty
                <tr><td colspan="7" class="px-4 py-8 text-center text-gray-400 dark:text-gray-500">Belum ada data warga.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
